...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.POST("/batch/daily_quota", controller.SetTokenDailyQuotaBatch)
		}
		...
		logRoute.GET("/self/token-analytics", middleware.UserAuth(), controller.GetUserTokenAnalytics)
		logRoute.GET("/self/token-analytics/trend", middleware.UserAuth(), controller.GetUserTokenAnalyticsTrend)
