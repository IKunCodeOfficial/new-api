...
func InitOptionMap() {
	...
	common.OptionMap["AutomaticDisableConsecutiveThreshold"] = operation_setting.AutomaticDisableConsecutiveThresholdToString()
	...
	common.OptionMap["GroupUnavailableMessage"] = setting.GroupUnavailableMessage2JSONString()
...
func validateOptionValue(key string, value string) error {
	...
	if key == "GroupUnavailableMessage" {
		_, err := setting.ParseGroupUnavailableMessages(value)
		return err
	}
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "GroupUnavailableMessage":
		err = setting.UpdateGroupUnavailableMessageByJSONString(value)
	...
	case "AutomaticDisableConsecutiveThreshold":
		operation_setting.AutomaticDisableConsecutiveThresholdFromString(value)
