...
func TestGetMaxTokenQuotaUsesWalletBounds(t *testing.T) {
	originalQuotaPerUnit := QuotaPerUnit
	t.Cleanup(func() { QuotaPerUnit = originalQuotaPerUnit })

	QuotaPerUnit = 500_000
	assert.Equal(t, 500_000_000_000_000, GetMaxTokenQuota())

	QuotaPerUnit = 1e20
	assert.Equal(t, MaxWalletQuota, GetMaxTokenQuota())
}
